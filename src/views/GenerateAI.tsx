...
export default function GenerateAI() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    //!Nueva técnica de validación
    //Esto crea de manera automatica todo el mapeo de datos del formulario
    const form = new FormData(e.currentTarget); //Esto genera el objeto del formdata en base al submit
    const prompt = form.get("prompt") as string; //Esto es obtener el contenido del <input name="prompt"/>
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {isGenerating && <p className="animate-pulse">Generando...</p>}
